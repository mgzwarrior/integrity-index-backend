...
class Politician(Base):
    ...
    govtrack_id = Column(String, nullable=True, unique=True, index=True)
    opensecrets_id = Column(String, nullable=True, unique=True, index=True)
    followthemoney_id = Column(String, nullable=True, unique=True, index=True)
